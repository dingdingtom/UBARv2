...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        ...
        # experiment settings
        self.mode = 'unknown'
        self.multi_gpu = False # multiple gpus
        self.local_rank = None # if use DDP, each process has its own local_rank
        self.world_size = None # number of processes in current group
        self.cuda = True
        self.cuda_device = [0,1,2,3]
        self.exp_no = ''
        self.seed = 11  # 和DAMD相同，是否需要调整
        ...
        self.use_cache = True # 加速解码 测试 'use_cache'
        ...
        self.context_scheme = 'UBARU' # UBARU or URURU or UBARU_GEN_CONTEXT

        self.exp_domains = ['all'] # hotel,train, attraction, restaurant, taxi
        self.log_path = 'logs_test'
        self.low_resource = False
        self.gen_context = 'r' # 'r' or 'bdar'
        ###
